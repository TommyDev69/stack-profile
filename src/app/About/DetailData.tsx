...
const DetailData: React.FC<DetailDataProps> = ({ result, title }) => {
    ...
    return (
        ...
        <div className=" mx-auto w-[90%] contaqiner my-16  flex flex-col md:flex-row">
            <div className="w-full md:w-[70%]  bg-blueBlack border-l-white border-l-2 shadow-inner shadow-white rounded-l-3xl">

                <h1 className="uppercase md:py-14 py-6 text-4xl md:textc-5xl text-center font-bold text-white">
                    meet the CEO
                </h1>
                ...
                <div className="border-2 p-6  w-[80%] mx-auto shadow-2xl  inset-5 shadow-white py-2">
                    ...
                    <p className="text-white mt-4 text-[10pxa] md:text-[14px]">{result[currentIndex].data}</p>
            ...
            <div className="w-full md:w-[30%] mt-14 md:mt-0  border-2 md:bg-white rounded-r-3xl relateive fleex juestify-center ">
                <Image src={Brandlogo} alt="ceo" className="md:w-[80%]   w-[60%]" />
                <div className="w-full md:ww=-[25%] text-center  bg-blueBlack absodlute flexx flwex-col items-cnenter  bodttom-14  md:py-2 py-0 ">
